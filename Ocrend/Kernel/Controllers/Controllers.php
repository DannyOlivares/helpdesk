...
abstract class Controllers {
    ...
    */
    ...
    protected $user_resetpass = array();
    ...
    */
    protected function __construct(IRouter $router, $configController = null) {
        ...
        if ($this->is_logged) {
          ...
          $this->user_resetpass = (new Model\Varios)->validar_cambio_pass($user['id_user']);
          $this->template->addGlobal('user_resetpass', $this->user_resetpass );
