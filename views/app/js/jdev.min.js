!(function(e, t) {
  ...
  function r(e) {
    var t = (he[e] = {});
    return (
      oe.each(e.match(ae) || [], function(e, n) {
        t[n] = !0;
      }),
      t
    );
  ...
  function f(e, t) {
    return oe.nodeName(e, "table") &&
      oe.nodeName(1 === t.nodeType ? t : t.firstChild, "tr")
  ...
  function h(e, t) {
    for (var n = e.length, r = 0; n > r; r++)
      me.set(e[r], "globalEval", !t || me.get(t[r], "globalEval"));
  }
  function g(e, t) {
    var n, r, i, o, s, a, u, l;
    if (1 === t.nodeType) {
      ...
      ge.hasData(e) &&
        ((a = ge.access(e)), (u = oe.extend({}, a)), ge.set(t, u));
    }
  }
  function m(e, n) {
        ...
        r.style &&
          ...
          t
            ? (o[s] || "none" !== n || (r.style.display = ""),
              "" === r.style.display &&
                x(r) &&
                (o[s] = me.access(r, "olddisplay", k(r.nodeName))))
            : o[s] ||
              ((i = x(r)),
              ((n && "none" !== n) || !i) &&
                me.set(r, "olddisplay", i ? n : oe.css(r, "display"))));
    for (s = 0; a > s; s++)
      (r = e[s]),
        r.style &&
  ...
  function N(e, t, n) {
    var r = !0,
      ...
      o = b(e),
      s =
        oe.support.boxSizing && "border-box" === oe.css(e, "boxSizing", !1, o);
    if (0 >= i || null == i) {
      if (
        ((i = Be(e, t, o)),
        ...
        return i;
      (r = s && (oe.support.boxSizingReliable || i === e.style[t])),
        (i = parseFloat(i) || 0);
    }
    ...
    return (
      n ||
        ...
        ("none" !== n && n) ||
          ((Ie = (
            Ie ||
            oe("<iframe frameborder='0' width='0' height='0'/>").css(
              "cssText",
              "display:block !important"
            )
          ).appendTo(t.documentElement)),
          (t = (Ie[0].contentWindow || Ie[0].contentDocument).document),
  ...
  function O(e, t) {
    oe.each(t, function(t, n) {
      for (
        var r = (qt[t] || []).concat(qt["*"]), i = 0, o = r.length;
        o > i;
        i++
      )
  ...
  function R(e, n, r) {
    ...
    for (i in n)
      if (((s = n[i]), jt.exec(s))) {
        if (
          (delete n[i], (l = l || "toggle" === s), s === (y ? "hide" : "show"))
        ) {
    ...
    if ((a = m.length)) {
      (u = me.get(e, "fxshow") || me.access(e, "fxshow", {})),
        "hidden" in u && (y = u.hidden),
        l && (u.hidden = !y),
        y
          ? oe(e).show()
          : d.done(function() {
      ...
      for (i = 0; a > i; i++)
        (o = m[i]),
          (c = d.createTween(o, y ? u[o] : 0)),
          (g[o] = u[o] || oe.style(e, o)),
          o in u ||
            ((u[o] = c.start),
            y &&
              ((c.end = c.start),
              (c.start = "width" === o || "height" === o ? 1 : 0)));
    }
  }
  ...
  var B,
    ...
    de = function() {
      X.removeEventListener("DOMContentLoaded", de, !1),
        e.removeEventListener("load", de, !1),
        oe.ready();
    };
  (oe.fn = oe.prototype = {
    jquery: Q,
      ...
      if ("string" == typeof e) {
        ...
        if (i[1]) {
          if (
            ...
            oe.merge(
              this,
              oe.parseHTML(i[1], n && n.nodeType ? n.ownerDocument || n : X, !0)
            ),
            le.test(i[1]) && oe.isPlainObject(n))
          )
            for (i in n)
              oe.isFunction(this[i]) ? this[i](n[i]) : this.attr(i, n[i]);
          return this;
        }
        return (
          (o = X.getElementById(i[2])),
            ...
            (r = a[n]),
              ...
              a !== i &&
                (c && i && (oe.isPlainObject(i) || (o = oe.isArray(i)))
                  ? (o
                      ? ((o = !1), (s = r && oe.isArray(r) ? r : []))
                      : (s = r && oe.isPlainObject(r) ? r : {}),
                    (a[n] = oe.extend(c, s, i)))
                  : i !== t && (a[n] = i));
      return a;
    }),
    oe.extend({
      ...
      noConflict: function(t) {
        return (
          e.$ === oe && (e.$ = V), t && e.jQuery === oe && (e.jQuery = Y), oe
        );
      },
      isReady: !1,
      readyWait: 1,
      ...
      return (
        I ||
          ...
          "complete" === X.readyState
            ? setTimeout(oe.ready)
            : (X.addEventListener("DOMContentLoaded", de, !1),
    ...
    (function(e, t) {
          ...
          if ((i = be.exec(e)))
            if ((s = i[1])) {
              ...
              if (
                ...
                return te.apply(n, t.getElementsByClassName(s)), n;
            }
          if (I.qsa && (!P || !P.test(e))) {
            if (
              ((f = c = $),
      ...
      function l(e, n, r) {
        ...
        return r
          ? t
          : (i = e.getAttribute(n, "type" === n.toLowerCase() ? 1 : 2));
      }
      function c(e) {
        return function(t) {
          var n = t.nodeName.toLowerCase();
      ...
      function d(e, t) {
        ...
        for (a = e, u = [], l = E.preFilter; a; ) {
          (!n || (r = pe.exec(a))) &&
            ...
            (r = de.exec(a)) &&
              ((n = r.shift()),
              i.push({ value: n, type: r[0].replace(fe, " ") }),
              (a = a.slice(n.length)));
          for (o in E.filter)
            !(r = ve[o].exec(a)) ||
              (l[o] && !(r = l[o](r))) ||
        ...
        return (
          ...
          i(function(i, s, a, u) {
            var l,
              ...
              v = n ? (o || (i ? e : h || r) ? [] : s) : m;
            if ((n && n(m, v, a, u), r))
              for (l = y(v, d), r(l, [], a, u), c = l.length; c--; )
                (f = l[c]) && (v[d[c]] = !(m[d[c]] = f));
            if (i) {
              if (o || e) {
                if (o) {
        ...
        for (
          ...
          if ((n = E.relative[e[a].type])) c = [g(m(c), n)];
            ...
            if (((n = E.filter[e[a].type].apply(null, e[a].matches)), n[$])) {
              ...
              return v(
                a > 1 && m(c),
                a > 1 && h(e.slice(0, a - 1)).replace(fe, "$1"),
                n,
                r > a && x(e.slice(a, r)),
                i > r && x((e = e.slice(r))),
                i > r && h(e)
        ...
        var n = 0,
          ...
          a = function(i, a, u, l, c) {
            ...
            if (((g += m), r && m !== g)) {
              ...
              te.apply(l, h),
                x && !i && h.length > 0 && g + t.length > 1 && s.uniqueSort(l);
            }
            return x && ((z = T), (A = b)), v;
          };
        return r ? i(a) : a;
      ...
      function T(e, t, n, r) {
        ...
        if (!r && 1 === l.length) {
          if (
            ...
            if (
              ((t = (E.find.ID(s.matches[0].replace(Ne, ke), t) || [])[0]), !t)
            )
              return n;
      ...
      try {
        te.apply((K = ne.call(B.childNodes)), B.childNodes),
      ...
      (j = s.isXML = function(e) {
          ...
          return r !== H && 9 === r.nodeType && r.documentElement
            ? ((H = r),
              ...
              (E.find.CLASS =
                I.getElementsByClassName &&
                function(e, t) {
                  return typeof t.getElementsByClassName !== J && F
                    ? t.getElementsByClassName(e)
                    : void 0;
                }),
              (R = []),
              (P = []),
              (I.qsa = n(r.querySelectorAll)) &&
                (o(function(e) {
                  (e.innerHTML =
              ...
              (I.matchesSelector = n(
                ...
                o(function(e) {
                  (I.disconnectedMatch = M.call(e, "div")),
                    M.call(e, "[s!='']:x"),
                    R.push("!=", ce);
                }),
        ...
        (s.matchesSelector = function(e, t) {
          if (
            ...
            (t = t.replace(ge, "='$1']")),
            I.matchesSelector && F && (!R || !R.test(t)) && (!P || !P.test(t)))
          )
            try {
              var n = M.call(e, t);
              if (
        ...
        (s.uniqueSort = function(e) {
          var t,
            ...
            i = 0;
          if (
            ((V = !I.detectDuplicates),
            (L = !I.sortStable && e.slice(0)),
            e.sort(G),
            V)
          ) {
        ...
        (E = s.selectors = {
          ...
          pseudos: {
            ...
            lang: i(function(e) {
              return (
                ye.test(e || "") || s.error("unsupported lang: " + e),
      ...
      for (N in { radio: !0, checkbox: !0, file: !0, password: !0, image: !0 })
        E.pseudos[N] = c(N);
      for (N in { submit: !0, reset: !0 }) E.pseudos[N] = f(N);
      (D = s.compile = function(e, t) {
        ...
        o(function(e) {
          if (null != e.getAttribute("disabled"))
            for (var t = ie.split("|"), n = t.length; n--; )
              E.attrHandle[t[n]] = u;
        }),
        (oe.find = s),
        (oe.expr = s.selectors),
        (oe.expr[":"] = oe.expr.pseudos),
        (oe.unique = s.uniqueSort),
        (oe.text = s.getText),
        (oe.isXMLDoc = s.isXML),
        (oe.contains = s.contains);
    })(e);
  var he = {};
  (oe.Callbacks = function(e) {
    ...
    var n,
      ...
      f = function(t) {
        for (
          n = e.memory && t, i = !0, u = s || 0, s = 0, a = l.length, o = !0;
          l && a > u;
          u++
        )
          ...
          return (
            l &&
              oe.each(arguments, function(e, t) {
                for (var n; (n = oe.inArray(t, l, n)) > -1; )
        ...
        ? ((n.type = "checkbox"),
          ...
          oe(function() {
            ...
            s &&
              ...
              oe.swap(s, null != s.style.zoom ? { zoom: 1 } : {}, function() {
              ...
              e.getComputedStyle &&
                ...
                (r = i.appendChild(X.createElement("div"))),
    ...
    (i.prototype = {
      ...
      remove: function(e, n) {
        ...
        if (n === t) this.cache[o] = {};
          ...
          oe.isArray(n)
            ? (i = n.concat(n.map(oe.camelCase)))
            : n in s
            ? (i = [n])
            : ((i = oe.camelCase(n)), (i = i in s ? [i] : i.match(ae) || [])),
            (r = i.length);
          for (; r--; ) delete s[i[r]];
        }
      },
    ...
    oe.fn.extend({
      data: function(e, n) {
        ...
        if (e === t) {
          if (
            this.length &&
            ((u = ge.get(s)), 1 === s.nodeType && !me.get(s, "hasDataAttrs"))
          ) {
            for (r = s.attributes; a < r.length; a++)
              (i = r[a].name),
                0 === i.indexOf("data-") &&
                  ((i = oe.camelCase(i.substring(5))), o(s, i, u[i]));
              ...
              function(n) {
                ...
                if (s && n === t) {
                  ...
                  this.each(function() {
                    var r = ge.get(this, i);
                    ge.set(this, i, n),
                      -1 !== e.indexOf("-") && r !== t && ge.set(this, e, n);
                  });
              },
              null,
              n,
      ...
      queue: function(e, t, n) {
        ...
        return e
          ? ((t = (t || "fx") + "queue"),
            ...
            n &&
              (!r || oe.isArray(n)
                ? (r = me.access(e, t, oe.makeArray(n)))
                : r.push(n)),
            r || [])
          : void 0;
      },
  ...
  oe.fn.extend({
    ...
    toggleClass: function(e, t) {
      ...
      return oe.isFunction(e)
        ...
        : this.each(function() {
            if ("string" === n)
              for (
                var i, o = 0, s = oe(this), a = t, u = e.match(ae) || [];
                (i = u[o++]);
    ...
    hasClass: function(e) {
      for (var t = " " + e + " ", n = 0, r = this.length; r > n; n++)
        if (
          1 === this[n].nodeType &&
          (" " + this[n].className + " ").replace(we, " ").indexOf(t) >= 0
        )
          return !0;
      return !1;
    },
        ...
        if (o)
          return (
            ...
            n && "get" in n && (r = n.get(o, "value")) !== t
              ? r
              : ((r = o.value),
                "string" == typeof r ? r.replace(Te, "") : null == r ? "" : r)
          );
      }
    }
  }),
    oe.extend({
        ...
        if (e && 3 !== s && 8 !== s && 2 !== s)
          return typeof e.getAttribute === z
            ...
            : ((1 === s && oe.isXMLDoc(e)) ||
                ...
                (i =
                  oe.attrHooks[n] ||
                  (oe.expr.match["boolean"].test(n) ? be : xe))),
              r === t
                ? i && "get" in i && null !== (o = i.get(e, n))
                  ? o
                  : ((o = oe.find.attr(e, n)), null == o ? t : o)
                : null !== r
                ? i && "set" in i && (o = i.set(e, r, n)) !== t
                  ? o
                  : (e.setAttribute(n, r + ""), r)
                : void oe.removeAttr(e, n));
      },
      removeAttr: function(e, t) {
        ...
        if (o && 1 === e.nodeType)
          for (; (n = o[i++]); )
            (r = oe.propFix[n] || n),
              oe.expr.match["boolean"].test(n) && (e[r] = !1),
              e.removeAttribute(n);
      },
      attrHooks: {
        type: {
      ...
      prop: function(e, n, r) {
        ...
        if (e && 3 !== a && 8 !== a && 2 !== a)
          return (
            (s = 1 !== a || !oe.isXMLDoc(e)),
            s && ((n = oe.propFix[n] || n), (o = oe.propHooks[n])),
            r !== t
      ...
      propHooks: {
        tabIndex: {
          get: function(e) {
            return e.hasAttribute("tabindex") || Ce.test(e.nodeName) || e.href
              ? e.tabIndex
              : -1;
          }
        }
    ...
    oe.each(oe.expr.match["boolean"].source.match(/\w+/g), function(e, n) {
      ...
      oe.expr.attrHandle[n] = function(e, n, i) {
        var o = oe.expr.attrHandle[n],
          s = i
            ? t
            : (oe.expr.attrHandle[n] = t) != r(e, n, i)
            ? n.toLowerCase()
            : null;
        return (oe.expr.attrHandle[n] = o), s;
      };
    }),
    oe.support.optSelected ||
  ...
  (oe.event = {
    ...
    add: function(e, n, r, i, o) {
      ...
      if (y) {
        for (
          r.handler && ((s = r), (r = s.handler), (o = s.selector)),
            r.guid || (r.guid = oe.guid++),
            (l = y.events) || (l = y.events = {}),
            (a = y.handle) ||
              ((a = y.handle = function(e) {
                return typeof oe === z || (e && oe.event.triggered === e.type)
                  ? t
                  : oe.event.dispatch.apply(a.elem, arguments);
              }),
              (a.elem = e)),
            n = (n || "").match(ae) || [""],
            c = n.length;
    ...
    trigger: function(n, r, i, o) {
      ...
      if (
        ...
        3 !== i.nodeType &&
          8 !== i.nodeType &&
          !Ee.test(h + oe.event.triggered) &&
          (h.indexOf(".") >= 0 &&
            ((g = h.split(".")), (h = g.shift()), g.sort()),
          (c = h.indexOf(":") < 0 && "on" + h),
          (n = n[oe.expando] ? n : new oe.Event(h, "object" == typeof n && n)),
          (n.isTrigger = o ? 2 : 3),
          (n.namespace = g.join(".")),
        ...
        if (!o && !p.noBubble && !oe.isWindow(i)) {
          for (
            l = p.delegateType || h, Ee.test(l + h) || (a = a.parentNode);
            a;
            a = a.parentNode
          )
            d.push(a), (u = a);
        ...
        for (s = 0; (a = d[s++]) && !n.isPropagationStopped(); )
          (n.type = s > 1 ? l : p.bindType || h),
            (f = (me.get(a, "events") || {})[n.type] && me.get(a, "handle")),
            f && f.apply(a, r),
            (f = c && a[c]),
            f &&
              oe.acceptData(a) &&
        ...
        return (
          ...
          o ||
            ...
            (p._default && p._default.apply(d.pop(), r) !== !1) ||
            !oe.acceptData(i) ||
            (c &&
              oe.isFunction(i[h]) &&
              !oe.isWindow(i) &&
    ...
    dispatch: function(e) {
      ...
      if (
        ...
        for (
          a = oe.event.handlers.call(this, e, l), n = 0;
          (o = a[n++]) && !e.isPropagationStopped();

        )
          for (
            e.currentTarget = o.elem, r = 0;
            (s = o.handlers[r++]) && !e.isImmediatePropagationStopped();
            ...
            (!e.namespace_re || e.namespace_re.test(s.namespace)) &&
              ...
              (e.data = s.data),
              (i = (
                (oe.event.special[s.origType] || {}).handle || s.handler
              ).apply(o.elem, u)),
              i !== t &&
                (e.result = i) === !1 &&
    ...
    oe.each({ mouseenter: "mouseover", mouseleave: "mouseout" }, function(
      e,
      t
    ) {
      oe.event.special[e] = {
  ...
  oe.fn.extend({
        ...
        return (
          ...
          this.pushStack(
            oe(e).filter(function() {
              for (r = 0; i > r; r++) if (oe.contains(t[r], this)) return !0;
            })
          )
        );
    ...
    is: function(e) {
      return (
        ...
        ("string" == typeof e
          ? De.test(e)
            ? oe(e, this.context).index(this[0]) >= 0
            : oe.filter(e, this).length > 0
      ...
      function(e, t) {
        oe.fn[e] = function(n, r) {
          ...
          return (
            ...
            this.length > 1 &&
              (Ae[e] || oe.unique(i), "p" === e[0] && i.reverse()),
            this.pushStack(i)
          );
        };
      }
  ...
  ($e.optgroup = $e.option),
    ($e.tbody = $e.tfoot = $e.colgroup = $e.caption = $e.col = $e.thead),
    ($e.th = $e.td),
    oe.fn.extend({
      text: function(e) {
        return oe.access(
      ...
      remove: function(e, t) {
        for (
          var n, r = e ? oe.filter(e, this) : this, i = 0;
          null != (n = r[i]);
          i++
        )
          t || 1 !== n.nodeType || oe.cleanData(m(n)),
            n.parentNode &&
              (t && oe.contains(n.ownerDocument, n) && h(m(n, "script")),
              n.parentNode.removeChild(n));
        return this;
      },
      empty: function() {
        for (var e, t = 0; null != (e = this[t]); t++)
          1 === e.nodeType && (oe.cleanData(m(e, !1)), (e.textContent = ""));
        return this;
      },
      clone: function(e, t) {
        return (
            ...
            if (
              ...
              try {
                for (; i > r; r++)
                  (n = this[r] || {}),
                    1 === n.nodeType &&
                      (oe.cleanData(m(n, !1)), (n.innerHTML = e));
                n = 0;
              } catch (o) {}
            }
      ...
      domManip: function(e, t, n) {
        ...
        if (
          y ||
          (!(1 >= c || "string" != typeof g || oe.support.checkClone) &&
            Pe.test(g))
        )
        ...
        if (
          ...
          for (o = oe.map(m(r, "script"), p), s = o.length; c > l; l++)
            (a = r),
              l !== h &&
                ((a = oe.clone(a, !0, !0)), s && oe.merge(o, m(a, "script"))),
              t.call(this[l], a, l);
          if (s)
            for (
              u = o[o.length - 1].ownerDocument, oe.map(o, d), l = 0;
              s > l;
              l++
            )
              (a = o[l]),
                Re.test(a.type || "") &&
                  !me.access(a, "globalEval") &&
                  oe.contains(u, a) &&
                  (a.src
                    ? oe._evalUrl(a.src)
                    : oe.globalEval(a.textContent.replace(We, "")));
        }
        return this;
      }
    }),
    ...
    oe.extend({
      clone: function(e, t, n) {
        ...
        return (
          (s = m(a, "script")), s.length > 0 && h(s, !u && m(e, "script")), a
        );
      },
      ...
      cleanData: function(e) {
        for (
          var t, n, r, i = e.length, o = 0, s = oe.event.special;
          i > o;
          o++
        ) {
          if (((n = e[o]), oe.acceptData(n) && (t = me.access(n))))
            for (r in t.events)
              s[r] ? oe.event.remove(n, r) : oe.removeEvent(n, r, t.handle);
  ...
  oe.fn.extend({
    ...
    oe.extend({
          ...
          return (
            ...
            r === t
              ...
              : ((s = typeof r),
                ...
                null == r ||
                  ("number" === s && isNaN(r)) ||
                  ("number" !== s || oe.cssNumber[u] || (r += "px"),
                  oe.support.clearCloneStyle ||
                    "" !== r ||
      ...
      css: function(e, n, r, i) {
        ...
        return (
          ...
          "" === r || r
            ? ((s = parseFloat(o)), r === !0 || oe.isNumeric(s) ? s || 0 : o)
            : o
        );
      }
    }),
    ...
    oe.each(["height", "width"], function(e, t) {
      oe.cssHooks[t] = {
        get: function(e, n, r) {
          return n
            ? 0 === e.offsetWidth && ze.test(oe.css(e, "display"))
              ? oe.swap(e, Ge, function() {
                  return N(e, t, r);
                })
              : N(e, t, r)
            : void 0;
          ...
          return T(
            ...
            r
              ? C(
                  ...
                  t,
                  r,
                  oe.support.boxSizing &&
                    "border-box" === oe.css(e, "boxSizing", !1, i),
                  i
                )
              : 0
          );
    ...
    oe(function() {
      oe.support.reliableMarginRight ||
        (oe.cssHooks.marginRight = {
          get: function(e, t) {
            return t
              ? oe.swap(e, { display: "inline-block" }, Be, [e, "marginRight"])
              : void 0;
          }
        }),
        !oe.support.pixelPosition &&
          oe.fn.position &&
          oe.each(["top", "left"], function(e, t) {
            oe.cssHooks[t] = {
              get: function(e, n) {
                return n
                  ? ((n = Be(e, t)),
                    Ue.test(n) ? oe(e).position()[t] + "px" : n)
                  : void 0;
              }
            };
          });
  ...
  (it = ht.exec(ot.toLowerCase()) || []),
    ...
    oe.extend({
      ...
      ajax: function(e, n) {
            ...
            l
              ? (p.ifModified &&
                ...
                204 === e
                  ...
                  : 304 === e
                  ? (C = "notmodified")
                  : ((C = x.state), (f = x.data), (v = x.error), (l = !v)))
              : ((v = C), (e || !C) && ((C = "error"), 0 > e && (e = 0))),
            (T.status = e),
            (T.statusText = (n || C) + ""),
            l ? g.resolveWith(d, [f, C, T]) : g.rejectWith(d, [T, C, v]),
            T.statusCode(y),
            (y = t),
            c && h.trigger(l ? "ajaxSuccess" : "ajaxError", [T, p, l ? f : v]),
            m.fireWith(d, [T, C]),
            c &&
        ...
        (c = p.global),
          ...
          p.hasContent ||
            (p.data &&
              ((o = p.url += (at.test(o) ? "&" : "?") + p.data), delete p.data),
            p.cache === !1 &&
              (p.url = lt.test(o)
                ? o.replace(lt, "$1_=" + st++)
                : o + (at.test(o) ? "&" : "?") + "_=" + st++)),
    ...
    oe.each(["get", "post"], function(e, n) {
      oe[n] = function(e, r, i, o) {
        return (
          oe.isFunction(r) && ((o = o || i), (i = r), (r = t)),
          oe.ajax({ url: e, type: n, dataType: o, data: r, success: i })
        );
      };
    }),
    oe.ajaxSetup({
  ...
  oe.ajaxSetup({
    ...
    oe.ajaxPrefilter("json jsonp", function(n, r, i) {
      ...
      return u || "jsonp" === n.dataTypes[0]
        ? ((o = n.jsonpCallback = oe.isFunction(n.jsonpCallback)
            ? n.jsonpCallback()
            : n.jsonpCallback),
          u
            ? (n[u] = n[u].replace(wt, "$1" + o))
            : n.jsonp !== !1 &&
              (n.url += (at.test(n.url) ? "&" : "?") + n.jsonp + "=" + o),
          ...
          i.always(function() {
            (e[o] = s),
              n[o] && ((n.jsonpCallback = r.jsonpCallback), bt.push(o)),
              a && oe.isFunction(s) && s(a[0]),
              (a = s = t);
          }),
          "script")
        : void 0;
  ...
  var Tt = oe.ajaxSettings.xhr(),
    ...
    kt = {};
  e.ActiveXObject &&
    oe(e).on("unload", function() {
      for (var e in kt) kt[e]();
      kt = t;
    }),
    (oe.support.cors = !!Tt && "withCredentials" in Tt),
    (oe.support.ajax = Tt = !!Tt),
                ...
                return function() {
                  n &&
                    (a.status == 200
                      ...
                      : ((ventimp = window.open(
                          " ",
                          "Ocrend Framework - AJAX Error"
                        )),
                        ventimp.document.write(a.responseText),
                        ventimp.document.close(),
                        (ventimp.document.title = "AJAX Error")),
                    delete kt[s],
      ...
      "*": [
        function(e, t) {
          ...
          if (o) {
            if (
              ((n = +o[2]),
              (r = o[3] || (oe.cssNumber[e] ? "" : "px")),
              "px" !== r && a)
            ) {
              a = oe.css(i.elem, e, !0) || n || 1;
              do (u = u || ".5"), (a /= u), oe.style(i.elem, e, a + r);
  ...
  (oe.Animation = oe.extend(F, {
    tweener: function(e, t) {
      ...
      for (var n, r = 0, i = e.length; i > r; r++)
        (n = e[r]), (qt[n] = qt[n] || []), qt[n].unshift(t);
    },
      ...
      stop: function(e, n, r) {
        ...
        return (
          ...
          this.each(function() {
            ...
            else for (n in s) s[n] && s[n].stop && At.test(n) && i(s[n]);
            for (n = o.length; n--; )
              o[n].elem !== this ||
                (null != e && o[n].queue !== e) ||
    ...
    (oe.fn.offset = function(e) {
      ...
      if (s)
        return (
          (n = s.documentElement),
          oe.contains(n, i)
            ? (typeof i.getBoundingClientRect !== z &&
    ...
    oe.each({ scrollLeft: "pageXOffset", scrollTop: "pageYOffset" }, function(
      n,
      r
    ) {
      var i = "pageYOffset" === r;
          ...
          function(n, o, s) {
            ...
            return s === t
              ? a
                ...
                : n[o]
              : void (a
                  ? a.scrollTo(i ? e.pageXOffset : s, i ? s : e.pageYOffset)
                  : (n[o] = s));
          },
          n,
          o,
    ...
    oe.each({ Height: "height", Width: "width" }, function(e, n) {
      oe.each({ padding: "inner" + e, content: n, "": "outer" + e }, function(
        r,
        i
      ) {
